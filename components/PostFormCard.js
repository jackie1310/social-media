...
export default function PostFormCard({onPost}) {
    ...
    const {profile, avatar, name} = useContext(UserContext)
    ...
    //https://qpbiaarsyanhunnrnchp.supabase.co/storage/v1/object/public/photos/1693125668254Screenshot%202023-08-26%20152057.png
        ...
        <Card>
            ...
            {uploads.length > 0 && (
                <div className="flex gap-2">
                    {uploads.map(upload => (
                        <div className="mt-2">
                            <img src={upload} alt="" className="w-auto h-12 rounded-md"/>
                        </div>
                    ))}
                </div>
            )}
