                ...
                <Card noPadding={true}>
                    <div className="relative overflow-hidden rounded-md">
                        ...
                        <div className="absolute top-24 left-4 z-20">
                            {profile && (
                                <Avatar url={profile?.avatar} editable={isMyUser} onChange={fetchUser} size={'lg'}/>
                            )}
                        </div>
                        <div className="p-4 pt-0 md:pt-4 pb-0">
                            <div className="ml-24 md:ml-40 flex justify-between">
                                <div>
                                    ...
                                    {!editMode && (
                                        <div className="text-gray-500 leading-4">{profile?.place || 'Unknown'}</div>
                                    )}
                                    {editMode && (
                                        <div>
                                            <input type="text" className="mt-1 border py-2 px-3 rounded-md" placeholder={'Your Location'} onChange={ev => setPlace(ev.target.value)} value={place}/>
                                        </div>
                                    )} 
                                </div>
